...
InteriorNet to ROS:
rosrun interiornet_to_rosbag interiornet_to_rosbag.py --scene-path /home/felix/line_ws/data/interiorNet/data/HD7/3FO4IDI9FO3C_Guest_room --output-bag-path /home/felix/line_ws/data/bags/HD7/3FO4IDI9FO3C_Guest_room.bag --frame-step 1 --light-type original --traj 1 --publish

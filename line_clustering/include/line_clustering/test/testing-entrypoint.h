...
#ifndef LINE_CLUSTERING_TESTING_ENTRYPOINT_H_
#define LINE_CLUSTERING_TESTING_ENTRYPOINT_H_
...
#define LINE_CLUSTERING_TESTING_ENTRYPOINT  \
  int main(int argc, char** argv) {         \
    common::UnitTestEntryPoint entry_point; \
    return entry_point.run(argc, argv);     \
  }

#endif  // LINE_CLUSTERING_TESTING_ENTRYPOINT_H_
